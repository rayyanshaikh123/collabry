...
const FocusMode: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center -m-4 md:-m-8 bg-slate-50 relative overflow-hidden">
      {/* Background Decor */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-indigo-400/5 rounded-full blur-[100px] pointer-events-none" />

      <div className="max-w-md w-full space-y-8 px-6 text-center z-10">
        <div className="space-y-2">
          <Badge variant="rose">Deep Work Session</Badge>
          <h2 className="text-4xl font-black text-slate-800 tracking-tight">Stay Focused</h2>
          <p className="text-slate-500">Silence notifications and dive into your work.</p>
        </div>
        ...
        <div className="relative group">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-2">Minutes Left</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 pt-8 border-t border-slate-200">
          ...
          <div>
            <p className="text-2xl font-bold text-slate-800">75m</p>
            <p className="text-[10px] font-bold text-slate-400 uppercase">Total Time</p>
          </div>
          <div>
            <p className="text-2xl font-bold text-slate-800">8d</p>
            <p className="text-[10px] font-bold text-slate-400 uppercase">Streak</p>
          </div>
        </div>

        <Card className="bg-white/80 backdrop-blur-md">
          <p className="text-xs text-slate-500 italic">"The secret of getting ahead is getting started." — Mark Twain</p>
        </Card>
      </div>
    </div>
  );
