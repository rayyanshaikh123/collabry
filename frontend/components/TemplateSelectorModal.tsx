          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filteredTemplates.map(template => (
              <button
                ...
                className="group relative bg-white border-2 border-slate-200 rounded-2xl p-6 hover:border-indigo-500 hover:shadow-xl transition-all duration-200 text-left"
              >
                {/* Template Icon/Preview */}
                <div className="w-full h-40 bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl flex items-center justify-center mb-4 group-hover:from-indigo-50 group-hover:to-purple-50 transition-all">
