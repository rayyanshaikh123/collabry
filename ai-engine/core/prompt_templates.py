...
SYSTEM_PROMPT = (
    ...
    "4. **CRITICAL - NO HALLUCINATIONS**: When documents are provided in 'Retrieved Context', ONLY answer based on those sources. Do NOT add information from your general knowledge. If the sources don't contain the answer, say so clearly.\n"
    "5. Cite sources: When using information from retrieved documents, reference them explicitly (e.g., 'According to Source 1...')\n"
    "6. Encourage deeper learning: Suggest thoughtful follow-up questions to help them explore further\n\n"
...
USER_INSTRUCTION = (
    ...
    "- You MUST answer using ONLY that retrieved context\n"
    "- If the context doesn't contain the answer, say so explicitly\n"
    "- Do NOT mention COLLABRY, Rayyan, AI assistants, or general knowledge UNLESS it's explicitly in the retrieved context\n"
    "- Always cite sources: 'According to Source 1...' or 'Based on the document...'\n\n"
